...
file_path <- "PCA_Global_PCA.txt"  # Ensure the file is in the working directory
...
SSA_samples <- c("Mota", "Dinka", "Mbuti", "Yoruba", "My-Simulated-ANA", "Public-Simulated-ANA")
eurasian_samples <- c("Anatolian-HG", "Anatolian-Neolithic", "WHG", "Han", "Ancient-North-Eurasian", "Ust-Ishim")
Admixed_samples <- c("Iberomaurusian", "Somali", "Tigray-Tigrinya", "Ari", "Morocco-Late-Neolithic","Levant-PPNB","Natufian","Iron-Age-Egyptian")
...
output_filename <- "G25_based_pca_generated_using_R.jpg"
