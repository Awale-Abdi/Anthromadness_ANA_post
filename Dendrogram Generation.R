...
file_path <- "PCA_Dendro.txt"  # Ensure the file is in the working directory
...
output_filename <- "G25_Based_Dendrogram_generated_in_R_using_My_Simulated_ANA_Component.jpg"
