...
input_file <- "PCA_ANA_Simulation.txt"  # Input file containing PCA coordinates
output_file <- "ANA_Simulation_Natufian_as_63.5_percent.txt"  # Output file for estimated ANA
